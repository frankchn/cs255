...
public class MITMAdminClientMAC
{
    ...
    public static void main( String [] args ) {
        MITMAdminClientMAC admin = new MITMAdminClientMAC( args );
        admin.run();
    }
     ...
     private Error printUsage() {
        System.err.println(
            "\n" +
            "Usage: " +
            "\n java " + MITMAdminClientMAC.class + " <options>" +
            "\n" +
    ...
    private MITMAdminClientMAC( String [] args ) {
        int remotePort = 8002;
    ...
    public void run() 
    {
		...
		//		System.out.println("challenge received:"+challenge+challenge.length());
